...
const user2 = new User('Mark', 'Smoth', 'email@email.com', 'sword');
const user3 = new User('Mark', 'Smoth', 'email@email.com', 'sword');
const user4 = new User('Mark', 'Smoth', 'email@email.com', 'sword');
const user5 = new User('Mark', 'Smoth', 'email@email.com', 'sword');
